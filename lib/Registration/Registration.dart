...
class RegistrationWindowState extends State<Registration> {
  ...
  final registrationbloc = RegistrationBloc(GetIt.I<AbstractUserModel>());
                ...
                Container(
                  ...
                  child: TextButton(
                    onPressed: () {
                      ...
                      abstractUserModel.phoneNumber = _phoneNumberController.text.toString();
                      ...
                      if(_firstPasswordController.text.toString() == _secondPasswordController.text.toString()){
                        abstractUserModel.password = _firstPasswordController.text.toString();
                      }
                      else{
